...
export class Room {
  ...
  // Factory for DB rows
  static fromDbRow(
    row: { id: string; name: string; creatorId: string; createdAt: number; type?: 'room'|'user'|null; isPublic?: number },
    users: User[] = []
  ): Room {
